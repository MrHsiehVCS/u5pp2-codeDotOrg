...
public class KingTests {
    ...
    public void King_canMoveOneSpaceAnyDirection_returnsTrue(){
        ...
        assertAll(
            () -> assertTrue(board[5][5].canMoveTo(4, 4), "Kings must be able to move 1 square in all directions"), 
            () -> assertTrue(board[5][5].canMoveTo(4, 5), "Kings must be able to move 1 square in all directions"), 
            () -> assertTrue(board[5][5].canMoveTo(4, 6), "Kings must be able to move 1 square in all directions"), 
            () -> assertTrue(board[5][5].canMoveTo(5, 4), "Kings must be able to move 1 square in all directions"), 
            () -> assertTrue(board[5][5].canMoveTo(5, 6), "Kings must be able to move 1 square in all directions"), 
            () -> assertTrue(board[5][5].canMoveTo(6, 4), "Kings must be able to move 1 square in all directions"), 
            () -> assertTrue(board[5][5].canMoveTo(6, 5), "Kings must be able to move 1 square in all directions"), 
            () -> assertTrue(board[5][5].canMoveTo(6, 6), "Kings must be able to move 1 square in all directions")
        );
    }
    ...
    public void King_canMoveTwoSpaces_returnsFalse(){
        board[5][5] = new King(board, 5,5, true);
        assertAll(
            () -> assertFalse(board[5][5].canMoveTo(3, 3), "Kings must not be able to move more than 1 square in all directions"), 
            () -> assertFalse(board[5][5].canMoveTo(3, 5), "Kings must not be able to move more than 1 square in all directions"), 
            () -> assertFalse(board[5][5].canMoveTo(3, 7), "Kings must not be able to move more than 1 square in all directions"), 
            () -> assertFalse(board[5][5].canMoveTo(5, 3), "Kings must not be able to move more than 1 square in all directions"), 
            () -> assertFalse(board[5][5].canMoveTo(5, 7), "Kings must not be able to move more than 1 square in all directions"), 
            () -> assertFalse(board[5][5].canMoveTo(7, 3), "Kings must not be able to move more than 1 square in all directions"), 
            () -> assertFalse(board[5][5].canMoveTo(7, 5), "Kings must not be able to move more than 1 square in all directions"), 
            () -> assertFalse(board[5][5].canMoveTo(7, 7), "Kings must not be able to move more than 1 square in all directions")
        );
    }
